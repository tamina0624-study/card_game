 ...
 * (`http://ss181301.stars.ne.jp/public_html/card_game/public`)から配信する
...
export const ASSET_BASE_URL = (
  process.env.NEXT_PUBLIC_ASSET_BASE_URL ?? "http://ss181301.stars.ne.jp/public_html/card_game/public"
).replace(/\/$/, "");
